...
func (ac *AccountCreate) SetID(u uint) *AccountCreate {
	ac.mutation.SetID(u)
	return ac
}

// AddEkycIDs adds the "ekycs" edge to the Ekyc entity by IDs.
func (ac *AccountCreate) AddEkycIDs(ids ...uint) *AccountCreate {
	ac.mutation.AddEkycIDs(ids...)
	return ac
}

// AddEkycs adds the "ekycs" edges to the Ekyc entity.
func (ac *AccountCreate) AddEkycs(e ...*Ekyc) *AccountCreate {
	ids := make([]uint, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
	return ac.AddEkycIDs(ids...)
}
...
func (ac *AccountCreate) check() error {
	if _, ok := ac.mutation.AccountName(); !ok {
		return &ValidationError{Name: "account_name", err: errors.New(`gen: missing required field "Account.account_name"`)}
	}
	return nil
}
...
func (ac *AccountCreate) createSpec() (*Account, *sqlgraph.CreateSpec) {
	...
	if nodes := ac.mutation.EkycsIDs(); len(nodes) > 0 {
